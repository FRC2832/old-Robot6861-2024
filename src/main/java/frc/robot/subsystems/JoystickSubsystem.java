...
public class JoystickSubsystem extends SubsystemBase {
    ...
    private boolean driverLeftStickPress;
    ...
    public JoystickSubsystem() {
        driverController = new CommandXboxController(RobotConstants.DRIVER_CONTROLLER);
        setDeadband(1.0);
        operatorController = new CommandXboxController(RobotConstants.OPERATOR_CONTROLLER);
    ...
    public void periodic() {
        ...
        driverLeftStickPress = driverController.leftStick().getAsBoolean();
    ...
    public boolean getDriverLeftStickButtonPressed() {
        return driverLeftStickPress;
    }
