...
public final class LightDrivePWM {
    ...
    public void Update() {
        double newduty = 0.0;
        int channels = ((this.m_matrix[0] > 127) ? 16 : 0) | ((this.m_matrix[1] > 127) ? 32 : 0)
                | ((this.m_matrix[2] > 127) ? 64 : 0) | ((this.m_matrix[3] > 127) ? 128 : 0)
                | ((this.m_matrix[4] > 127) ? 256 : 0) | ((this.m_matrix[5] > 127) ? 512 : 0);
        ...
        channels = (((this.m_matrix[6] > 127) ? 16 : 0) | ((this.m_matrix[7] > 127) ? 32 : 0)
                | ((this.m_matrix[8] > 127) ? 64 : 0) | ((this.m_matrix[9] > 127) ? 128 : 0)
                | ((this.m_matrix[10] > 127) ? 256 : 0) | ((this.m_matrix[11] > 127) ? 512 : 0));
        newduty = channels / 1023.0;
        if (this.m_type_servo) {
